...
```{r hanuman, fig.cap= "Breathe in deeply, zoom in, and surrender to the power of nature.", fig.margin = TRUE, out.width = "75%", fig.align='center', echo=FALSE}
knitr::include_graphics("images/hanuman.jpg")
```
...
```{r intro, fig.cap= "Picture taking with a [Fairphone](https://www.fairphone.com/en/). If you are a modern sapiens that cares about this planet and the species on it, check it out. (Morality-based promotion. No personal earnings).", fig.margin = TRUE, out.width = "75%", fig.align='center', echo=FALSE}
