## Disclaimer: I am not your doctor. But, I could be your grandma. {-}

In Spain, the country I am from, grandmas are known for giving all sort of advices and remedies for virtually any type of problem. Thus, I prefer that you take me as your grandma, and avoid thinking that I am any type of health authority. This sections is just to add the classical "*I am not a doctor*" message. Use your common sense, take all this practices as a gamified personal exploration, and never put your well-being under extreme situations or circumstances^[However, if you are like me, you probably don’t care about this, and you’ll end up doing whatever you want. At least, I'll sleep better knowing that I wrote this sort of disclaimer.]. 

In a similar way as David Cain, writer of [*Raptitude*](http://www.raptitude.com/), and its [post on unsolicited life advice](https://www.raptitude.com/2015/02/67-short-pieces-of-advice-you-didnt-ask-for/), here it is a quick list of my habits and practices for a good life.^[If you want to know more, I have a blog where I post different types of things from time to time. You may find something useful there as well. [Carlito Fluito Website](www.carlitofluitoideas.com). Check [*Dreams and morning reflections*](https://carlitofluito.github.io/dreams/) in the [Unfinished books](https://www.carlitofluitoideas.com/unfinished-books/)section to know my morning and evening routines.]. The habits and practices evolve from more to less work related. 
...
###  Drop plastic and extra packaging
